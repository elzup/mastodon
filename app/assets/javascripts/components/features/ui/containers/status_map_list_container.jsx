...
import StatusMapList from '../../../components/status_map_list';
...
export const mapDispatchToProps = (dispatch, { type, id }) => ({
...
export default connect(makeMapStateToProps, mapDispatchToProps)(StatusMapList);
